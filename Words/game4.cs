...
namespace Words
{
    public partial class game4 : Form
    {
        ...
        private void game4_Load(object sender, EventArgs e)
        {
            ...
            string selectQuery = "SELECT word FROM [Words4]";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string selectQuery = $"SELECT COUNT(*) FROM [Words4] WHERE word = N'{userWord}'";
            SqlCommand selectCommand = new SqlCommand(selectQuery, sqlConnection);
            ...
            if (existingCount == 0)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string insertQuery = $"INSERT INTO [Words4] (word) VALUES (N'{userWord}')";
