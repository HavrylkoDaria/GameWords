...
namespace Words
{
    public partial class game3 : Form
    {
        ...
        private void game3_Load(object sender, EventArgs e)
        {
            ...
            string selectQuery = "SELECT word FROM [Words3]";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string selectQuery = $"SELECT COUNT(*) FROM [Words3] WHERE word = N'{userWord}'";
            SqlCommand selectCommand = new SqlCommand(selectQuery, sqlConnection);
            ...
            if (existingCount == 0)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string insertQuery = $"INSERT INTO [Words3] (word) VALUES (N'{userWord}')";
