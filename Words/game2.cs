...
namespace Words
{
    public partial class game2 : Form
    {
        ...
        private void game2_Load(object sender, EventArgs e)
        {
            ...
            string selectQuery = "SELECT word FROM [Words2]";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string selectQuery = $"SELECT COUNT(*) FROM [Words2] WHERE word = N'{userWord}'";
            SqlCommand selectCommand = new SqlCommand(selectQuery, sqlConnection);
            ...
            if (existingCount == 0)
            {
                ...
                if (result == DialogResult.Yes)
                {
                    ...
                    string insertQuery = $"INSERT INTO [Words2] (word) VALUES (N'{userWord}')";
